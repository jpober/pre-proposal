...
All three initiatives will be directed by a full-time project administrator whose, ideally with training in physics and/or physics education, whose primary responsibility will be the education component.  All programs will be heavily integrated with each other and with the programs being implemented under the HERA grant, as described below.  
% JA: I don't love this statement any more, as it looks like the PI is abdicating responsibility is vague.  I also think that research management should be discussed in the research statement.  
